            ...
            <div className="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl relative z-10">
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-extrabold text-white tracking-tight">
                        {isOtpMode ? 'Check Your Inbox' : 'Create Account'}
                    </h2>
                    <p className="text-sm text-emerald-200 mt-2">
                        {isOtpMode
                            ? `We sent a 6-digit code to ${email}`
                            : 'Sign up for instant automated career alerts'}
                    </p>
                </div>
                ...
                {isOtpMode ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="text-center mt-6 text-sm">
                            ...
                            <Link to="/login" className="ml-2 font-medium text-emerald-400 hover:text-emerald-300 transition-colors cursor-pointer">
                                Sign In
                            </Link>
                        </div>
